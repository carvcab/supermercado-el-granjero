...
async function main() {
  ...
  const cfg = {
    fields: {
      version: { stringValue: '3.2.4' },
      mensaje: { stringValue: 'Corrección de cálculo en Caja Negocio al cerrar caja y sincronización de movimientos' },
