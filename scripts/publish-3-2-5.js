...
async function main() {
  ...
  const cfg = {
    fields: {
      version: { stringValue: '3.2.5' },
      mensaje: { stringValue: 'Corrección de la separación de cuentas entre Caja Negocio (Capital) y Ganancias acumuladas' },
